...
/**
 * Interactive Lead Capture & Newsletter Opt-In Form Component.
 *
 * @usecase Captures subscriber email and first name for email campaigns, newsletter signups, and lead magnets, syncing to Brevo.
 * @param {NewsletterOptInFormProps} props UI customization parameters.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/v1/subscribe', {
        ...
        body: JSON.stringify({ email: cleanEmail, firstName: firstName.trim() || undefined, source }),
      });
